    ...
    <section className="bg-white px-4 pb-14 pt-8 sm:px-6 lg:px-8 lg:pt-12">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-14">
        <div className="max-w-xl">
          ...
          <h1 className="text-4xl font-bold leading-[1.06] tracking-[-0.02em] text-[#232B3F] sm:text-6xl lg:text-[64px]">
            Supercharge Your
            <br />
            Digital Workflow
          </h1>

          <p className="mt-6 max-w-xl text-base leading-relaxed text-[#6B768E] sm:text-[17px]">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <a
              href="#"
              className="inline-flex h-11 items-center rounded-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] px-6 text-base font-semibold text-white shadow-[0_8px_20px_rgba(79,57,246,0.28)] sm:h-12 sm:px-7 sm:text-[17px]"
            >
              Explore Products
            </a>
            ...
            <a
              href="#"
              className="inline-flex h-11 items-center gap-3 rounded-full border border-[#8A63FA] bg-white px-6 text-base font-medium text-[#5B33F8] sm:h-12 sm:px-7 sm:text-[17px]"
            >
        ...
        <div className="relative mx-auto w-full max-w-140 lg:justify-self-end">
